...
# ── DISCHARGE rows ────────────────────────────────────────────────────────────
aws dynamodb put-item --region $AWS_REGION --table-name $TABLE --item '{"PK":{"S":"MEMBER#member-789"},"SK":{"S":"DISCHARGE#2026-03-20T00:00:00Z"},"memberId":{"S":"member-789"},"dischargeDate":{"S":"2026-03-20"},"admissionReason":{"S":"Cardiac arrhythmia"},"dischargeMedications":{"L":[{"S":"rx-007"},{"S":"rx-008"}]},"readmissionWindowDays":{"N":"30"}}'
aws dynamodb put-item --region $AWS_REGION --table-name $TABLE --item '{"PK":{"S":"MEMBER#member-321"},"SK":{"S":"DISCHARGE#2026-03-28T00:00:00Z"},"memberId":{"S":"member-321"},"dischargeDate":{"S":"2026-03-28"},"admissionReason":{"S":"Severe depressive episode"},"dischargeMedications":{"L":[{"S":"rx-011"},{"S":"rx-012"}]},"readmissionWindowDays":{"N":"30"}}'
